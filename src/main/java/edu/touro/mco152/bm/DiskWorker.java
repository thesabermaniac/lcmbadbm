...
public class DiskWorker extends SwingWorker<Boolean, DiskMark> {
    /**
     * Initialize local variables to keep track of read and write data.
     * Removed these from the doInBackground() method so they can be accessed
     * by both the readTest() and writeTest() methods.
     */
    int startFileNum = 0;
    ...
    /**
     * This method has been de-coupled from the doInBackground() method. This is to comply with SRP
     * and makes the code easier to read and navigate. It also gives non-Swing methods the abiltiy
     * to run tests.
     */
    ...
    /**
     * Like the writeTest() method, this has also been de-coupled from doInBackground() to comply with SRP
     * @throws IOException
     */
    ...
    private void setDiskRunVars(DiskRun run) {
